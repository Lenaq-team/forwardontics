...
const PendingReviewsPage = () => {
    ...
    const { reviews, isLoading, isError, mutate } = useReviews('pending');
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <Breadcrumb className="mb-6 hidden md:block">
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>Pending Reviews</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            ...
            <div className="mb-8 mt-8 md:mt-0">
                ...
                <p className="text-gray-600">
                    Review and provide feedback on patient video submissions
                </p>
            </div>
                        ...
                        <Table>
                            <TableHeader className="bg-secondary text-white">
                                <TableRow className="border-b">
                                    ...
                                    <TableHead><Skeleton className="h-4 w-14 bg-white/20" /></TableHead>
                                    <TableHead><Skeleton className="h-4 w-16 bg-white/20" /></TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
